...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        // lowAccelClip : The engine at low revs, with throttle open (i.e. beginning acceleration at very low speed)
        ...
        public float dopplerLevel = 1; // The amount of doppler effect used in the audio
        ...
        // sets up and adds new audio source to the game object if none is attached, otherwise uses existing one
        private AudioSource SetUpEngineAudioSource(AudioClip clip)
        {
            // Check if there's already an AudioSource attached to this GameObject
            AudioSource source = GetComponent<AudioSource>();

            // If there is no AudioSource, add a new one
            if (source == null)
            {
            ...
            // Set up properties for the AudioSource (or the existing one)
            source.clip = clip;
          //  source.volume = 0;
            source.loop = true;
