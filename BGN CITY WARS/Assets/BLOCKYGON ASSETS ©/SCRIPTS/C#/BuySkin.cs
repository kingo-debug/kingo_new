...
public class BuySkin : MonoBehaviour
{
    ...
    public void Buy()
    {
        ...
        // Check if the player has enough of the selected currency and doesn't already own the skin
        if ((goldPrice > 0 && ES3.Load<int>("BGNCoins") >= goldPrice) ||
            (cashPrice > 0 && ES3.Load<int>("BGNCash") >= cashPrice) &&
            !shopitems.OwnedSkins.Contains(SkinID))
        {
            // Success purchase
            ...
            // Add the skin to owned items, enable equip button, and save
